      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl w-full">
        ...
        >
          ...
          <div className="relative h-full flex flex-col justify-end p-8 transition-transform duration-500 group-hover:-translate-y-2">
            ...
            <p className="text-white/80">Explore my kiteboarding journey and adventures</p>
          </div>
        </Link>
        ...
        >
          ...
          <div className="relative h-full flex flex-col justify-end p-8 transition-transform duration-500 group-hover:-translate-y-2">
            ...
            <p className="text-white/80">Discover my software engineering projects and expertise</p>
          </div>
        </Link>
      </div>
    </div>
