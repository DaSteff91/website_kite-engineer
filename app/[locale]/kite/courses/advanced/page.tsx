...
export default function AdvancedPage() {
  return (
   ...
   bg-clip-text text-transparent animate-gradient"
            ...
            <p id="advanced-section-subtitle" className="mt-4 text-lg sm:text-xl text-center text-white/80 max-w-3xl mx-auto leading-relaxed">
