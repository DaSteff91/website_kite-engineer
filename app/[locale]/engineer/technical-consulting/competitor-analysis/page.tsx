...
export default function CompetitorAnalysisPage() {
  return (
      ...
      <section className="py-12 sm:py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="relative mb-16 sm:mb-20">
            <h2 id="competitor-analysis-section-title"
   ...
   bg-clip-text text-transparent animate-gradient"
            ...
            <p id="competitor-analysis-section-subtitle" className="mt-4 text-lg sm:text-xl text-center text-white/80 max-w-3xl mx-auto leading-relaxed">
              Professional competitive intelligence gathering and analysis to
