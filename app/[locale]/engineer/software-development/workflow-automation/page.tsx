...
export default async function WorkflowAutomationPage({
  ...
  return (
    <div className="relative min-h-screen">
      ...
      >
        <h1
          id="workflow-automation-hero"
          className="pb-1 text-4xl md:text-5xl font-bold mb-6 
     bg-gradient-to-r from-white via-gray-200 to-gray-300 
     bg-clip-text text-transparent 
     [text-shadow:0_0_8px_rgba(209,213,219,0.6)]"
        >
          {t("workflow-automation-hero")}
        </h1>
      </Hero>
      {/* Content Section */}
      <section className="py-12 sm:py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="relative mb-16 sm:mb-20">
            <h2
              id="workflow-automation-section-title"
              className="text-xl sm:text-2xl md:text-3xl font-bold text-center max-w-4xl mx-auto leading-relaxed 
   bg-[linear-gradient(to_right,white,rgba(229,231,235,0.8),rgba(209,213,219,1))] 
   bg-clip-text text-transparent animate-gradient"
            >
              {t("workflow-automation-section-title")}
            </h2>
            <p
              id="workflow-automation-section-subtitle"
              className="mt-4 text-lg sm:text-xl text-center text-white/80 max-w-3xl mx-auto leading-relaxed"
            >
              {t("workflow-automation-section-subtitle")}
            </p>
          ...
          <div className="text-center">
            <p
              id="workflow-automation-contact"
              className="text-xl text-white/90 mb-8 max-w-6xl mx-auto"
            >
              {t("workflow-automation-contact")}
            </p>
            <Link
              href={hrefForTemplateWithTranslator(contactT, "/engineer/software-development/workflow-automation")}
              target="_blank"
            >
              <Button
                size="lg"
