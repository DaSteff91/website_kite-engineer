      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-xl font-semibold mb-12 text-center text-white/90">
            ...
            <div className="grid gap-8">
              ...
              <div className="bg-gradient-to-br from-card/50 to-card/30 backdrop-blur-sm p-6 rounded-lg border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.12)] hover:shadow-[0_8px_32px_rgba(255,255,255,0.1)] transition-all duration-300">
                <h3 className="text-xl font-semibold mb-4 pb-3 border-b border-white/20 flex items-center gap-3">
