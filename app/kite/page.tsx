...
export default function KitePage() {
  ...
  //         Start your kiteboarding journey with comprehensive lessons tailored to
  //         beginners.
  //       </p>
  //     </div>
  ...
  //       <p className="text-muted-foreground">
  //         Perfect your skills with advanced training and specialized techniques.
  //       </p>
  //     </div>
  ...
  return (
    <main className="container mx-auto px-4 py-16">
      <section>
        {/*this section shall later contain the hearo image */}
        ...
        <div className="relative pt-24">
          <section className="container mx-auto px-4 py-16">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                From beginner lessons to advanced techniques, discover the
                perfect blend of sport and nature
              </p>
              <Button size="lg" className="group">
                Start Your Journey
              </Button>
